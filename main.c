...
#include "componentes/player/player.h"
...
void turno_jogador(Territorio *raiz, Jogador *jogador, Jogador *adversario)
{
  ...
  while (!turno_concluido)
  {
    ...
    Territorio *lateral_esq = buscar_vizinho_esquerda(raiz, jogador->atual);
    Territorio *lateral_dir = buscar_vizinho_direita(raiz, jogador->atual);
...
int main()
{
  ...
  Territorio *raiz = mundo_construir_completa();
  ...
  Territorio *spawn1 = buscar_folha_esquerda(raiz);
  Territorio *spawn2 = buscar_folha_direita(raiz);
